    ...
    const amountCol = (amount, type) => {
        return (
            <div style={{marginBottom:12}}>
                ...
                <Text fw={700} fz="md" style={{marginBottom:12,color: '#26AB35'}}>{"+ " + amount.toLocaleString("en-US") + " VND"}</Text> : <Text fw={700} fz="md" style={{marginBottom:12}}>{"- " + amount.toLocaleString("en-US") + " VND"}</Text>}
            </div>
        )
    }
